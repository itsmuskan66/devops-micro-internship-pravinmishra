...
**Before** (Screenshot 6): "Empowering thousands of students towards success."

**After**: hero tagline changed to "Empowering thousands of students towards DevOps success." in `index.html`, re-uploaded with `aws s3 cp` (overwriting the old object), and verified live after a hard refresh.

![Screenshot 7](screenshots/a2-ss7.png)

---

# Live S3 Website Endpoint

`http://pravin-portfolio-javeson-ap-southeast-5.s3-website.ap-southeast-5.amazonaws.com`

- Bucket: `pravin-portfolio-javeson-ap-southeast-5` in Asia Pacific (Malaysia) `ap-southeast-5`
- Block Public Access: public ACLs stay blocked; only the bucket policy grants public read (`s3:GetObject`)
- Verified: homepage, `style.css` and images return HTTP 200; a missing page returns `error.html` with HTTP 404
